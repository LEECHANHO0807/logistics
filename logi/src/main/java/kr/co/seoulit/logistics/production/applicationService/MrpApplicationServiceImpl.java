...
public class MrpApplicationServiceImpl implements MrpApplicationService {
	...
	public ArrayList<MrpGatheringTO> getMrpGathering(ArrayList<String> mrpNoArr) {
	   ...
	   public HashMap<String, Object> registerMrpGathering(
			   String mrpGatheringRegisterDate, ArrayList<String> mrpNoArr,HashMap<String, String> mrpNoAndItemCodeMap) {
	               //선택한날짜        
	      ...
	      ArrayList<MrpGatheringTO> mrpGatheringList = null;
	         ...
	         ArrayList<MrpGatheringTO> list = mrpGatheringDAO.selectMrpGatheringCount(mrpGatheringRegisterDate); //선택한날짜
	         ...
	         seq=mrpGatheringDAO.getMrpGatheringSeqNo(); // 
